...
class PatientBed extends Model
{
    ...
    {
        return $this->belongsTo(HospitalHerlog::class, 'enccode', 'enccode')->select('enccode', 'erstat', 'erdtedis', 'hpercode', 'erdate')->whereNull('erdtedis')->where('erstat', 'A')->latest('erdtedis');
