...
<div class="flex flex-col w-full">
    ...
    <div class="w-full p-4 two">
        <div class="w-full p-4 space-y-2 bg-white rounded-lg">
            <div class="px-3">
                <div class="mt-0 bg-gray-200 border-4 border-gray-700 rounded-md ">
                            ...
                            <div class="flex space-x-0">
                                ...
                                <div class="bg-white border-2 border-t-0 border-l-0 border-gray-600">
                                    <div class="mt-2 ">
                                        ...
                                        <div class="p-2">
                                            <h6 class="p-1 mt-1 text-sm text-center text-black rounded-md bg-sky-400">
                                                RESU</h6>
                                        </div>
                        ...
                        <div class=""> <!--third start-->
                            <div class="flex flex-row gap-4 p-2 bg-white border-2 border-t-0 border-gray-600">
                                ...
                                <div class="flex flex-col mt-2 ml-2"> <!-- pedia bed 1 bed 2 bed 3-->
                                    ...
                                    <div class="p-2">
                                        <h4 class="p-1 mt-6 text-sm text-center text-black bg-yellow-300 rounded-md">
                                            PEDIA
                                        </h4>
                                    </div>
                                </div>
