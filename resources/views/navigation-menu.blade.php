    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-12">
            <div class="flex">
                ...
                @if (Auth::user())
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        {{-- <x-nav-link href="{{ route('admin.user_list') }}" :active="request()->routeIs('admin.user_list')" class="text-white">
                            {{ __('Users') }}
                        </x-nav-link> --}}
                    </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @endif
                @if (Auth::user())
                    <div class="relative ml-3"> <!--User list and roles, permissions-->
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md ">
                                    <button type="button"
                                        class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-white transition duration-150 ease-in-out border border-transparent rounded-md bg-emerald-600 hover:text-gray-300 focus:outline-none focus:bg-emerald-700 active:bg-emerald-700">
                                        <i class="">Users</i>
                            ...
                            <x-slot name="content">
                                <x-dropdown-link href="{{ route('admin.user_list') }}" :active="request()->routeIs('admin.user_list')"
                                    class="text-black">
                                    {{ __('Users') }}
                                </x-dropdown-link>
                    ...
                    </div> <!--User list and roles, permissions-->
                    <!-- Settings Dropdown -->
                    <div class="relative ms-3">
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
